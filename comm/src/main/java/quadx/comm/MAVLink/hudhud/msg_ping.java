...
public class msg_ping extends MAVLinkMessage {
	...
	public int seq;
	/**
	 * 0: request ping from all receiving systems, if greater than 0: message is
	 ...
	 * is a ping response and number is the system id of the requesting system
	 */
	...
	public String toString() {
		return "MAVLINK_MSG_ID_PING -" + " time:" + time + " seq:" + seq
				+ " target_system:" + target_system + " target_component:"
				+ target_component + "";
	}
}
